...
\resumeSubHeading
    ...
    {Present}
    \begin{itemize}
        \item Managing events, seminar programs, machine learning bootcamp, and campus outreach for group of 50 students
        \item Leading a research program with three ongoing AI alignment projects collaborating with EleutherAI
\end{itemize}
...
\resumeSubHeading
    ...
    {Present}
\begin{itemize}
    \item Measuring ability for value learning techniques to capture the heterogeneity of human preferences 
    \item Comparing human survey responses to LLM outputs before and after reinforcement-learning fine-tuning
\end{itemize}
